...
Shader "RealToon/Version 4/No Outline/Fade Transparency" {
    Properties {

        [Header((RealToon V4.1.2))]
    	[Header((No Outline x Fade Transparency))]
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma only_renderers d3d9 d3d11 glcore gles3 metal d3d11_9x xboxone ps4
            #pragma target 3.0

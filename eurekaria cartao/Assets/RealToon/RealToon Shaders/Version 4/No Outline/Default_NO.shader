...
Shader "RealToon/Version 4/No Outline/Default" {
    Properties {

        [Header((RealToon V4.1.2))]
    	[Header((No Outline x Default))]
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_3266,float3(node_2058,node_2058,node_2058),_ReflectionIntensity),node_3266,_UseFReflection),dot(lerp(lerp(node_3266,float3(node_2058,node_2058,node_2058),_ReflectionIntensity),node_3266,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(lerp(lerp(node_3266,float3(node_2058,node_2058,node_2058),_ReflectionIntensity),node_3266,_UseFReflection),dot(lerp(lerp(node_3266,float3(node_2058,node_2058,node_2058),_ReflectionIntensity),node_3266,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
